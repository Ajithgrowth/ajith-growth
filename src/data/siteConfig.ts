...
export const siteConfig = {
  ...
  heroH1: "Turn Google Searches Into High-Value Construction Opportunities.",
  heroSupportingCopy: "Ajith Growth helps residential construction companies attract qualified homeowners through Google Ads, Local SEO, Google Business Profile, conversion-focused landing pages and measurable growth systems.",
  ...
  founder: {
    ...
    experience: "Specialist Google Growth Consultant",
    bio: "Founder of Ajith Growth, specializing in Google Ads, Local SEO, Google Business Profile optimization, and conversion tracking for residential construction companies.",
    statement: "I built Ajith Growth because residential construction companies deserve marketing systems that understand their business. Winning high-value building projects requires disciplined qualification, clear Google visibility, and measurable results.",
  },
  primaryServices: [
